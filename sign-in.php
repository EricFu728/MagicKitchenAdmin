    ...
    <div class="navbar navbar-default" role="navigation">
        ...
        <div class="dialog">
            <?php if($error && $error==1){
                echo "<p class=\"bg-danger text-center\">用户名或密码错误!</p>";
            }elseif($error && $error==2){
                echo "<p class=\"bg-danger text-center\">Token失效,请重新登录!</p>";
            }elseif($logout && $logout==1){
                echo "<p class=\"bg-warning text-center\">Logout成功!</p>";
            }?>
        ...
        <div class="panel-body">
            <form method="post" action="doSignIn.php">
                <div class="form-group">
                    <i class="fa fa-user"><label>&nbsp;Username&nbsp;</label></i>
                    <input type="text" name="username" class="form-control span12">
                </div>
                <div class="form-group">
                <i class="fa fa-unlock-alt"><label>&nbsp;Password&nbsp;</label></i>
                    <input type="password" name="password" class="form-controlspan12 form-control">
                </div>
                <div class="form-group">
                    <i class="fa fa-cutlery">
                    <label>&nbsp;Store&nbsp;</label></i>
                    <select name="store_code" class="form-controlspan12 form-control">
                        <option value="888">Magic Kitchen</option>
                    </select>
                </div>
